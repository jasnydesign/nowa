...
<div id="loading" class="loading text-center">	<progress></progress> <br> Proszę czekać...</div>
...
<header class="bez">
	<div id="hedek">
		<div class="container">
			<nav>
				<div class="col-md-4">
					<a href="index.html"><img src="images/1489639891_Cake.png" class="img-responsive logo2"  alt=""></a>
				</div>
				<ul class="col-md-8 text-right">
					...
					<li><a href="recenzje.html">Listy</a>
					<ul class="dropdown-menu dropek-admin">
						<li><a href="lista2zad1.php">Lista2_zad1</a></li>
						<li><a href="lista2zad2.php">Lista2_zad2</a></li>
						<li><a href="lista2zad3.php">Lista2_zad3</a></li>
						<li><a href="lista3zad1.php">Lista3_zad1</a></li>
					</ul></li>
				</ul>
			</nav>	
		</div>
...
<section class="slider2 text-center">
	<h1>
		Z nami szybko zostaniesz mistrzem kuchni :)
	</h1>
</section>
